...
class SurgicalDinoFusion(nn.Module):
    ...
    def __init__(self,
        ...
        # Deep fusion head: concat(384+1) → project กลับเป็น 384
        self.fusion = DeepFusionHead(self.embed_dim, aux_dim=1, dropout=head_dropout)
    ...
    def forward(self, pixel_values: torch.Tensor, length_feat: torch.Tensor) -> torch.Tensor:
        ...
        # Fusion: concat visual embedding + length scalar → project
